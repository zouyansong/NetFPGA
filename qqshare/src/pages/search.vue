<template>
  <div>
      <div class="demo-home">
        <el-form :inline="true" :model="form" class="demo-form">
          <el-form-item label="文件名" style="margin-right:3%">
            ...
            <el-form-item label="教师名" style="margin-right:3%">
                <el-input style="width:200px" v-model="form.teacher" placeholder="请输入教师名"></el-input>
            </el-form-item>
        ...
        <div id = 'loading'>
          <el-card style="margin:0 9% 20px 5%">
            <div>
          ...
          <el-card style="margin:0 9% 20px 5%" v-for="(item,index) in data_show" :key="index">
              <div>
                <p style="font-size:120%"><span style="color:#409eff">{{item.filename}}</span> &nbsp;&nbsp;&nbsp;&nbsp;{{item.show_info}}</p>
              </div>
              <div>
                <span style="font-size:120%">下载次数:{{item.downloadtime}} &nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span style="font-size:120%">上传时间:{{item.uploadtime}} &nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span style="font-size:120%">文件大小:{{toFilesize(item.filesize)}} &nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span style="font-size:120%">文件格式:{{item.fileformat}}</span>
                <el-button class="button1" type="text" @click="download(item)"><i class="el-icon-download"></i>点击下载</el-button>
              </div>
            </el-card>
          </div>
        <div class="block">
